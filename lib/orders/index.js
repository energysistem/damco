...
function createOrderFile(req, res, next) {
    ...
    fs.appendFileSync(filepath, data.header.shipping.phone.padRight(20) + data.header.shipping.palletized + data.header.channel);
    while (i--) {
